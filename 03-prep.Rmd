...
```{r rasterggplotfunction,out.width="100%",echo=FALSE}
...
```{r cityraster1,echo=FALSE,out.width="100%",fig.cap="Population in a 5 kilometer grid."}
grid.arrange(
...
```{r citiesraster2,out.width="100%",echo=FALSE,fig.cap="Population in a 5 kilometer grid."}
grid.arrange(
...
```{r borderraster1,out.width="100%",echo=FALSE,fig.cap="Population in a 5 kilometer grid."}
grid.arrange(
...
```{r borderraster2,out.width="100%",echo=FALSE,fig.cap="Population in a 5 kilometer grid."}
grid.arrange(
