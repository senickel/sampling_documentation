...
```{r}
# tf <- readLines("data/fdgs/malawi.txt") %>% 
#   matrix(ncol=2,byrow=TRUE) %>% 
#   apply(2,function(x) strsplit(x,":") %>% 
#           sapply(`[[`,2) %>% 
#           gsub(" ","",.) %>% 
#           gsub("S","-",.) %>% 
#           gsub("E","",.))
...
#         
#         %>% 
#           sapply(function(y) y[1]as.numeric(y[2])/60)))
