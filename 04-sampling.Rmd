...
nairobi_sample_100 <- oversample_wrapper_non_pair(name = "Nairobi",
                            bins = nairobi_bins,
...
writeOGR(nairobi_sample_100[nairobi_sample_100$pick=="Sample",],
         "output/nairobi_sample_100.kml",
         driver="KML",layer="nairobi",
         overwrite_layer = TRUE)


writeOGR(nairobi_sample_150[nairobi_sample_150$pick=="Sample",],
         "output/nairobi_sample_150.kml",
         driver="KML",layer="nairobi",
         overwrite_layer = TRUE)
